...
<table width="900" border="0" align="center"> 
 ...
 <tr>
     ...
     <p>&nbsp;</p>
         ...
         System.out.println("Employee Aggreement Page  dBOperation=="+dBOperation);
	        HrmsEmployee hrmsEmployee = new HrmsEmployee();
	        hrmsEmployee = (HrmsEmployee)session.getAttribute("hrmsEmployee");
	         System.out.println("Employee Aggreement Page  hrmsEmployee=="+hrmsEmployee.getEmpId());
        ...
        <%
	        ...
	        System.out.println("Employee Aggreement Page  dBOperation(ifblock)=="+dBOperation);
